        ...
        <FormProvider {...methods}>
            <form className="h-screen w-screen bg-slate-800 p-5">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    {!isNameChoice && <Button className="mt-5" onClick={() => setisNameChoice(true)}>Continuer</Button>}
                </div>

            </form>
            <Button className="mt-5" onClick={() => append({ key: '', type: '' })}>+</Button>
            <Button className="mt-5" onClick={() => methods.handleSubmit(data => onSubmit(data))()}>Envoyer</Button>
            <Button className="mt-5" onClick={() => setIsOPen()}>Fermer</Button>
        </FormProvider>
    )
}
